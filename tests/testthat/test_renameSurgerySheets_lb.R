...
test_that("extract_filename() works", {
  expect_equal(extract_filename(pn_1), "08-09-10   16550.pdf")
  expect_equal(extract_filename(pn_2), "3-15-11  19111.pdf")
  expect_equal(extract_filename(pn_3), "10-22-10 19231.pdf")
  expect_equal(extract_filename(pn_4), "5-11--09  19105.pdf")
  expect_equal(extract_filename(pn_5), "08-17--06  27795.pdf")
  expect_equal(extract_filename(pn_6), "06--27-06  10126.pdf")
  expect_equal(extract_filename(pn_7), "2-7-11 4x0293.pdf")
  expect_equal(extract_filename(pn_8), "3-25-11 13788 @ 10.45am.pdf")
  expect_equal(extract_filename(pn_9), "8-31-07-29008.pdf")
  expect_equal(extract_filename(pn_10), "8-2-07-16859.pdf")
  expect_equal(extract_filename(pn_11), "7-11-07-16287-glp.pdf")
  expect_equal(extract_filename(pn_12), "11-1-07-17977.pdf")
  expect_equal(extract_filename(pn_13), "6-03-08-9395NS.pdf")
  expect_equal(extract_filename(pn_14), "10-16--08-29710.pdf")
  expect_equal(extract_filename(pn_15), "10-07=05 17254.pdf")
  expect_equal(extract_filename(pn_16), "10-08=5 17254.pdf")
  expect_equal(extract_filename(pn_17), "1-12-2007-14379.pdf")
})
